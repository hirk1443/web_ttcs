              ...
              <Form form={passwordForm} layout="vertical">
                ...
                >
                  <PasswordInput
                    ...
                    onChange={(e) =>
                      passwordForm.setFieldValue("oldPassword", e.target.value)
                    }
                  />
                </Form.Item>
                <Form.Item
        ...
        <List
          ...
          renderItem={(item) => (
            <List.Item
              ...
              className={`cursor-pointer my-2 p-2 rounded-lg transition-all duration-300 ${
                selectedMenu === item.key ? "bg-gray-200" : "bg-white"
              }`}
            >
              <List.Item.Meta
                avatar={<div className="pl-2">{item.icon}</div>}
                title={item.title}
              />
            </List.Item>
          )}
