      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <form action="" className="flex items-center">
            ...
            />
            <button className="p-2 bg-blue-123 text-white rounded-md ml-2">
              SEND
            </button>
          </form>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <p>Email</p>
              <Link
                to="mailto:contact@grocerymart.com"
                className="hover:underline"
              >
                contact@tlkhmpkv.com
              </Link>
            </li>
            <li>
              <p>Hotline</p>
              <Link to="tel:18008888" className="hover:underline">
                18008888
              </Link>
            </li>
            <li>
