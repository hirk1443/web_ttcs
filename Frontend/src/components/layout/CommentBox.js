...
export default function CommentBox() {
  ...
  try {
    ...
    // ✅ Cập nhật danh sách comment ngay
  ...
  >
    <img
      src={c.author.profile_img || "https://ui-avatars.com/api/?name=User"}
    ...
    <div style={{ flex: 1 }}>
      <div
        style={{
          fontWeight: 600,
          fontSize: 16,
          marginBottom: 8, // Tăng khoảng cách giữa tên và nội dung
          color: "#111827",
        }}
      >
        {c.author.name || c.author.email}
      </div>
      <div style={{ fontSize: 15, color: "#374151", wordBreak: "break-word" }}>
        {c.body}
      </div>
    </div>
  </div>
